...
const CMD_HELP_TEXT =
  ...
  'Также запишите голосовое — бот транскрибирует и создаст транзакцию.\n\n' +
  '✏️ <b>БЫСТРОЕ РЕДАКТИРОВАНИЕ</b>\n' +
  'Чтобы изменить поле последней транзакции, просто напишите:\n' +
  '<blockquote>Измени сумму\n' +
  'Измени категорию\n' +
  'Измени счёт\n' +
  'Измени тип</blockquote>\n' +
  'Бот мгновенно откроет нужный редактор — без лишних кликов.\n\n' +
  '📊 <b>ОТЧЁТЫ</b>\n' +
