...
Продукты: молоко, хлеб, мясо, овощи, фрукты, крупы, яйца, масло, сахар, макароны, рис, сыр, колбаса, рыба, курица, снеки, чипсы, шоколад, вода, сок, чай (в магазине)
Кафе и рестораны: кофе, обед, ужин, завтрак, пицца, суши, бургер, шаурма, борщ, доставка еды, Glovo, ресторан, кафе, бар, фастфуд, столовая
Транспорт: такси, метро, автобус, бензин, дизель, парковка, штраф ПДД, мойка, шиномонтаж, ТО, Uber, Bolt, проездной, электричка, каршеринг
Жильё: аренда, коммуналка, свет, газ (коммунальный), вода (коммунальная), отопление, ипотека, ремонт квартиры, сантехник, электрик
Здоровье: аптека, лекарства, врач, стоматолог, анализы, МРТ, УЗИ, витамины, линзы, очки, прививка, массаж (лечебный)
Одежда: куртка, штаны, джинсы, футболка, рубашка, платье, юбка, пальто, кроссовки, ботинки, сапоги, шорты, трикотаж, камуфляж, форма, нижнее бельё, носки, шапка, перчатки, шарф, свитер, толстовка
Красота: парикмахерская, стрижка, маникюр, педикюр, косметика, крем, шампунь, барбершоп, салон красоты, брови, ресницы, краска для волос
Развлечения: кино, театр, концерт, музей, парк, зоопарк, квест, боулинг, караоке, игры, PlayStation, Steam, Xbox, настолки
Подписки: Netflix, Spotify, YouTube Premium, iCloud, Apple Music, VPN, ChatGPT, антивирус, облако
Связь: мобильная связь, интернет, роуминг, SIM-карта
Образование: курсы, книги, учебники, репетитор, школа, университет, Udemy, Coursera, мастер-класс, вебинар
Спорт: абонемент, тренажёрный зал, фитнес, бассейн, йога, тренер, протеин, спортпит, спортивная форма
Путешествия: авиабилет, отель, хостел, Airbnb, виза, страховка туриста, экскурсия, трансфер
Подарки: подарок, цветы, букет, открытка, сертификат
Дети: подгузники, детское питание, игрушки, коляска, детская одежда, кружок, няня, детский сад, школьные принадлежности
Питомцы: корм (для животных), ветеринар, наполнитель, ошейник, поводок, груминг, прививки (животным), клетка, аквариум, еда для кота/собаки
Дом: моющие средства, тряпки, полотенца, посуда, мебель, шторы, лампочки, пылесос, утюг, постельное бельё, стиральный порошок, губки, мусорные пакеты, бытовая химия, кастрюли
