...
| 2026-05-18 10:53 | **fix(export): Account name step3, correct filename, CSV filters (2bf24d2). DEPLOYED.** Step3 показывает «Bybit · USDT» вместо ULID. Filename = реальный период. exportTransactionsCSV(dateFrom, dateTo, accountId). tsc 0. |
